...
public class DataGenUtil {
  ...
  public static String removeDoubleQuotes(String str) {
    return (str.startsWith(FORWARD_SLACE) && str.endsWith(FORWARD_SLACE) ?    StringUtils.replace(str, FORWARD_SLACE, "") : str);
 
  }

  public static String removeSingleQuotes(String str) {
    return (str.startsWith(COMMA) && str.endsWith(COMMA) ? StringUtils.replace(str, COMMA, "") : str);
  }
